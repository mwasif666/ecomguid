...
const teamData = [
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185140/2_Name_Ali_Raza_Ebay_Team_Lead_ll0m3v.png",
    memberName: "Ali Raza",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185140/3_Ali_Haider_Ebay_Specialist_jlzuhq.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185140/4_Nouman_Muavia_Ebay_Specialist_tgezvp.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185140/5_M_Muzammil_Ebay_Specialist_jaraao.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185142/6_Ali_Akbar_Etsy_Specialist_pd99vr.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185141/7_Ali_Hamza_Etsy_Specialist_avft3r.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185140/8_Saqlain_Raza_Etsy_Specialist_nedqyp.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185142/9_Junaid_Khan_Etsy_Specialist_idblzu.png",
  ...
  {
    memberImg:
      "https://res.cloudinary.com/dr0pxq6py/image/upload/v1772185141/10_Ukasha_Khan_Etsy_Specialist_oyvlr7.png",
  ...
  {
    memberImg:
      "https://cdn.vectorstock.com/i/500p/82/65/person-gray-photo-placeholder-woman-vector-24138265.jpg",
...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <Spacing lg="75" md="60" />
      <AboutStyle4
        thumbnailSrc="https://res.cloudinary.com/dr0pxq6py/image/upload/v1772213254/1c0c85e0-f22f-44d3-99e9-88c2009fc50e.png"
        miniTitle="About Us"
