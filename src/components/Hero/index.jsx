...
export default function Hero({ title, subtitle, bgUrl }) {
  ...
  return (
    <section className="cs_hero cs_style_1 cs_primary_bg position-relative">
      ...
      {/* ✅ VideoModal removed — Image block added */}
      <div className="cs_video_block_wrap position-relative">
        <div className="container">
          <div
            className="cs_hero_media position-relative"
            style={{
              borderRadius: "20px",
              overflow: "hidden",
            }}
          >
            {/* Optional overlay (remove if you don't want dark layer) */}
            <div
