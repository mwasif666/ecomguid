...
import Ebay from "./components/Pages/Ebay";
import Etsy from "./components/Pages/Etsy";
import PortfolioDetailsPage from "./components/Pages/PortfolioDetailsPage";
// import PortfolioDetailsPage2 from "./components/Pages/PortfolioDetailsPage2";
...
import WhatsAppFloat from "./components/whatsappFloaticon/WhatsAppFloat";
...
function App() {
  ...
  return (
    <>
      {/* ✅ Floating button must be OUTSIDE Routes */}
      <WhatsAppFloat
        phone="923461120978"
      ...
      <Routes>
        ...
        <Route path="/" element={<Layout darkMode />}>
          <Route path="marketing-agency" element={<MarketingAgencyPage darkMode />} />
